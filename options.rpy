...
define config.version = "alpha 1.1-0611"
...
define gui.about = _p("""
    ...
    制作组：リア充fireworks & 魔法少女委员会

    此项目为剧情体验版，并不代表正式版的品质。
...
define config.save_directory = "HelloWorld-1686033097"
...
init python:
    ...
    build.classify('game/audio/**.opus', 'archive')
    ...
    build.classify('game/**.tff', 'archive')
    build.classify('game/tl/**.rpy', 'archive')
...
## 执行应用内购买需要一个Google Play许可证密钥。它可以在Google Play开发者控制台
## 的 "Monetize" > "Monetization Setup" > "Licensing "下找到。
...
# define build.itch_project = "renpytom/test-project"
    ...
    build.directory_name = "Techvorious"
