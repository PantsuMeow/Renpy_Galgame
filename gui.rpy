...
define gui.accent_color = '#ffccff'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#ff69b4'
...
## 处于选中状态。
define gui.selected_color = '#ffccff'
...
define gui.interface_text_color = '#ffccff'
define gui.version_text_color = "#cccccc"
define gui.mmt_text_color = "#ffffff"


## 字体和字体大小 #####################################################################

## 游戏内文本使用的字体。
define gui.text_font = "loli.ttc"

## 角色名称使用的字体。
define gui.name_text_font = "loli.ttc"
