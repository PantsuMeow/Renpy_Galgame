...
## 航菜单。
##
## 滚动参数可以是无，或者是 "viewport "或 "vpgrid "中的一个。这个屏幕旨在与一个
## 或多个孩子一起使用，这些孩子被反括（放置）在它里面。
...
screen nvl(dialogue, items=None):
    ...
    window:
        ...
        ## 显示菜单，如果给定的话。如果config.narrator_menu被设置为True，菜单可
        ## 能会被错误地显示。
        for i in items:
...
## 泡沫屏幕 ########################################################################
##
## 泡泡屏幕用于在使用语音泡泡时向玩家显示对话。泡泡屏的参数与say屏相同，必须创
## 建一个id为 "what "的可显示文件，并且可以创建id为 "namebox"、"who "和 "window
## "的可显示文件。
##
